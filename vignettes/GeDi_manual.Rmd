...
Finally, we'll append the gene symbols to the resultant `data.frame`, which will later serve as our "Genes" column in the input data for `r #BiocStyle::Biocpkg("GeDi")` `GeDi`.
