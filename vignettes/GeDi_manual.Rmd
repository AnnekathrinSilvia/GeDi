...
Afterwards, we perfrom the DE analysis and test against a null hypothesis of a log2FoldChange of 1 in order to ensure that we call those genes with a consistent *and* robust expression change DE.
...
TODO: maybe function erstellen, die die columns renamed? 
