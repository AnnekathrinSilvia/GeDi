...
A: You can use nearly any result of a functional enrichment analysis in `r BiocStyle::Biocpkg("GeDi")` as long as the results are trassnformed in a way that they fit the input requirements. Please check out the <b>Welcome</b> page to see the specification of the input requirements. 
