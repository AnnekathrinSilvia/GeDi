...
scoring_heatmap <- distanceHeatmap(reactive_values$scores[[1]])
scoring_heatmap
```

```{r dendro}
if(!is.null(reactive_values$scores[[1]])){
dendro <- distanceDendro(reactive_values$scores[[1]], input$cluster_method_dendro)
dendro
}
```
